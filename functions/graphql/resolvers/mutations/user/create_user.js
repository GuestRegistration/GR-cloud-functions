...
const createUser = async (parent, {id, email, phone, first_name, last_name}, context) => {
    client_middleware(context)
        ...
        else if((await firestore.collection(collections.user.main).where('phone', '==', phone).get()).size > 0){
